<%@ Page Title="" Language="C#" MasterPageFile="~/Visao/MasterPage.Master" AutoEventWireup="true" CodeBehind="Alterar.aspx.cs" Inherits="PSI.Visao.CadastroPagamentoSalario.Alterar" Theme="css" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Alteração de Pagamento de Salário</h2>
        <table>
            <tr>
            ...
            <tr>
                <td><asp:Label ID="Label2" runat="server" Text="Funcionário"></asp:Label></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="TextBox3" runat="server" TextMode="DateTime"></asp:TextBox></td>
            </tr>
            <tr>
                <td><asp:Label ID="Label4" runat="server" Text="Mês / Ano de Referência"></asp:Label></td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text="Valor Pago"></asp:Label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="TextBox4">*</asp:RequiredFieldValidator>
                </td>
