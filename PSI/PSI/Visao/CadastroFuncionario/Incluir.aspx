<%@ Page Title="" Language="C#" MasterPageFile="~/Visao/MasterPage.Master" AutoEventWireup="true" CodeBehind="Incluir.aspx.cs" Inherits="PSI.Visao.CadastroFuncionario.Incluir" Theme="css" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Inclusão de Funcionário</h2>
        <table>
            ...
            <tr>
                <td><asp:Label ID="Label2" runat="server" Text="Telefones"></asp:Label></td>
            ...
            <tr>
                <td><asp:Label ID="Label7" runat="server" Text="Técnico"></asp:Label></td>
                <td><asp:CheckBox ID="CheckBox2" runat="server" /></td>
            </tr>
            <tr>
                <td><asp:Label ID="Label8" runat="server" Text="Observação"></asp:Label></td>
